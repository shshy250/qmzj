<template>
	<div class="normalOrder">
		...
		<div class="tabs">
			...
			<div :class="[tabSelect=='2'?'tab-active':'tab-every']">待发货</div>
			<div :class="[tabSelect=='3'?'tab-active':'tab-every']">待用户收货</div>
			<div :class="[tabSelect=='4'?'tab-active':'tab-every']">租用中</div>
			<div :class="[tabSelect=='5'?'tab-active':'tab-every']">待归还</div>
			<div :class="[tabSelect=='6'?'tab-active':'tab-every']">待结算</div>
			<div :class="[tabSelect=='7'?'tab-active':'tab-every']">订单完成</div>
		</div>
		<div class="table-content">
			<el-table :data="tableData" border :cell-style="{'text-align': 'center',}" :header-cell-style="{'text-align': 'center', 'background-color':'#f8f8f8'}" style="width: 100%">
				...
				<el-table-column prop="time" label="起租日期">
				</el-table-column>
				<el-table-column prop="time" label="归还日期">
				</el-table-column>
				<el-table-column prop="time" label="当前租期">
				</el-table-column>
				<el-table-column prop="time" label="总租金">
				</el-table-column>
				<el-table-column prop="time" label="已付租金">
				</el-table-column>
