<template>
	<div class="renewalOrder">
		...
		<div class="tabs">
			...
			<div :class="[tabSelect=='2'?'tab-active':'tab-every']">租用中</div>
			<div :class="[tabSelect=='3'?'tab-active':'tab-every']">待归还</div>
			<div :class="[tabSelect=='4'?'tab-active':'tab-every']">待结算</div>
			<div :class="[tabSelect=='5'?'tab-active':'tab-every']">订单完成</div>
		</div>
		<div class="table-content">
			<el-table :data="tableData" border :cell-style="{'text-align': 'center',}" :header-cell-style="{'text-align': 'center', 'background-color':'#f8f8f8'}" style="width: 100%">
				...
				<el-table-column prop="time" label="当前日期">
				</el-table-column>
				...
				<el-table-column prop="options" width="150px" label="操作">
